$(function () {
    ...
    $(".s-color a").click(function (e) {
        ...
        $('link[id="color_theme"]').attr(
            "href",
            "static/css/color/" + color_code + ".css"
        );
